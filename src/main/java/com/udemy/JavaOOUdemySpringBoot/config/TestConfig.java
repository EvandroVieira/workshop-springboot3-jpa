...
import com.udemy.JavaOOUdemySpringBoot.entities.*;
import com.udemy.JavaOOUdemySpringBoot.entities.enums.OrderStatus;
import com.udemy.JavaOOUdemySpringBoot.repositories.*;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Payment pay1 = new Payment(null, Instant.parse("2024-11-20T21:53:07Z"),o1);
        o1.setPayment(pay1);
